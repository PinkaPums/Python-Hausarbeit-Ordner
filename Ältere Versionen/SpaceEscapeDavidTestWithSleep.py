...
def gefangenentraktZentrale(environment):
    ...
    elif cmd == 'gehe zu narrez' or cmd == 'gehe zu mann' or cmd == 'untersuche mann' or cmd == 'untersuche narrez' or cmd == 'rede mit mann' or cmd == 'rede mit narrez':
        if mMonsterGesehen[0] != 'Ja':
            time.sleep(0.5)
...
def gefangenentraktZentraleKeinNarrezMehr(environment):
    print("Da liegt ein toter Narrez auf dem Boden")
    exit()

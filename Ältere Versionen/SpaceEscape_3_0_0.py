...
def treppenhausGZ(environment):
    ...
    if cmd == '1':
        ...
        if iGenerator[0] == 'An' and iBewFrau[0] != 'Traurig' or iNarrezMerana[0] != 'Wissend':
...
def mannschaftsquartiereFlur2(environment):
    ...
    if cmd == '1':
        ...
        print("Der Rotäugige rennt gegen die Wand und macht ein Nickerchen, im Raum is nix für dich.")
        print("...")
        time.sleep(5)
        print("Wehmütig schließt du die Tür.")
        time.sleep(2)
        mannschaftsquartiereFlur2(environment)
...
def raumH(environment):
    ...
    cmdlist = ['1', 'umsehen', 'öffne schrank', 'untersuche bett', 'untersuche betten',]
    cmd = getcmd(cmdlist)
    ...
    if cmd == '1':
        ...
        if cmd == '1':
            ...
            time.sleep(1.5)
            print("'Aufzeichnungen vom 13.05.49201")
            print(" ")
...
def medAbteilung(environment):
    if 'Jonas Laserkanone' in mW and iMedAbtEingang[0] == 'Verschlossen':
        ...
        if cmd == '1':
            ...
            print("vorbei kommst, kann ich dich nochmal versorgen.")
